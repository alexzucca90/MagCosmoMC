...
!-------
! MagCosmoMC: changing the parameters
!    call this%SetTheoryParameterNumbers(16,last_power_index)
call this%SetTheoryParameterNumbers(18,last_power_index+1)
!-------
...
!--------
! MagCosmoMC: new fast params
 CMB%maglrat = Params(19)
!--------
...
!---------------------------------------
! MagCosmoMC: adding the new slow param 
 CMB%magind = Params(18)
 CMB%magamp = Params(17)
! Log prior trick
!CMB%magamp = 10.d0**(Params(17))
!---------------------------------------
        call SetFast(Params,CMB)
    end if
