!=====================================================
! May 2016: adding SPT likelihood for magnetic fields:
...
!ALEX: reading SPT B modes stuff.
    	write(*,*) "CMB_SPT: doing SPT stuff.."
    	use_SPTpol = Ini%Read_Logical('use_SPTpol', .false.)
    	if(use_SPTpol) then
    		write(*,*) "------ SPT LIKELIHOOD ------"
    		write(*,*) "calling SPT_ReadParams"
    		call SPT_ReadParams(LikeList,Ini)
    		write(*,*) "done."
    	end if
    	write(*,*) "CMB_SPT: done."
    	WRITE(*,*) "----------------------------"
