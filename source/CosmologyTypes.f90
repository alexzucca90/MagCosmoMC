...
!----------------------
! MagCosmoMC: choosing the type of magnetic contributions one wants to calculate
logical :: scalar_compensated = .false.
logical :: scalar_passive = .false.
logical :: vector_compensated = .false.
logical :: tensor_compensated = .false.
logical :: tensor_passive = .false.
!----------------------
...
!-------
! MagCosmoMC: adding the new parameters
real(mcp):: magamp, magind, maglrat
!-------
...
!------
! MagCosmoMC: taking care of fast/slow params
!    index_initpower = num_hard+1
index_initpower=num_hard+2
!-------
...
!-----------------
!MagCosmoMC: reading which magnetic modes to compute
this%scalar_compensated = Ini%Read_Logical('scalar_compensated',.false.)
this%scalar_passive	= Ini%Read_Logical('scalar_passive',.false.)
this%vector_compensated	= Ini%Read_Logical('vector_compensated',.false.)
this%tensor_compensated	= Ini%Read_Logical('tensor_compensated',.false.)
this%tensor_passive	= Ini%Read_Logical('tensor_passive',.false.)
!-----------------
